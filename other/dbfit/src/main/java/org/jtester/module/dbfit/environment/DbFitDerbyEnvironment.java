...
public class DbFitDerbyEnvironment extends DbFitAbstractDBEnvironment {
	public DbFitDerbyEnvironment(DBEnvironment dbEnvironment) {
		super(dbEnvironment);
	}
	...
	private Map<String, DbParameterAccessor> readIntoParams(String tableOrViewName, String query) throws SQLException {
		checkConnectionValid(this.connect());
