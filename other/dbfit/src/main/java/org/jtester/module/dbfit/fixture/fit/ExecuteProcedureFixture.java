...
public class ExecuteProcedureFixture extends Test4JFixture {
    ...
    public ExecuteProcedureFixture(DbFitEnvironment dbEnvironment, String procName, int expectedErrorCode) {
    ...
    public ExecuteProcedureFixture(DbFitEnvironment dbEnvironment, String procName, boolean exceptionExpected) {
        this.procName = procName;
        this.environment = dbEnvironment;
    ...
    public ExecuteProcedureFixture(DbFitEnvironment dbEnvironment, String procName) {
    ...
    public CallableStatement buildCommand(String procName, DbParameterAccessor[] accessors) throws SQLException {
        ...
        CallableStatement cs = environment.connect().prepareCall(ins.toString());
        for (DbParameterAccessor ac : accessors) {
