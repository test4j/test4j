...
public interface DbFitOp {
     ...
     * 
     * <pre>
     * 	|connect|mysql|com.mysql.jdbc.Driver|jdbc:mysql://localhost/test4j?characterEncoding=UTF8|root|password|
     * </pre>
     * 
     * @param type 数据库类型
     * @param driver 驱动程序
    ...
    /**
     * 使用配置文件建立连接,prefix是数据库连接属性前缀 wiki语法<br>
     * 
     * <pre>
     ...
     * @param propFile 如果为null，则读取test4j配置项
     * @return
     * @throws Exception
     */
