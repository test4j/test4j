...
import org.test4j.module.dbfit.exception.FitRunException;
...
public class FitRunner {
    ...
    protected FitRunner(String fitDir) {
        this.testRunner = new test4jFitLibraryTestEngine();
        this.fitDir = fitDir;
        this.prepareFiles();
    }
    ...
    public static final String Fitnesse_Css_Resource_Path = "org/test4j/fit/fitnesse_base.css"; // "files/css/fitnesse_base.css";
