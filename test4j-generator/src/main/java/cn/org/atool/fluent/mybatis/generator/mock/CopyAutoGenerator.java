...
public class CopyAutoGenerator {
    ...
    public CopyAutoGenerator setDataSource(DataSourceConfig dataSource) {
    ...
    public CopyAutoGenerator setStrategy(StrategyConfig strategy) {
    ...
    public CopyAutoGenerator setPackageInfo(PackageConfig packageInfo) {
    ...
    public CopyAutoGenerator setTemplate(TemplateConfig template) {
    ...
    public CopyAutoGenerator setConfig(ConfigBuilder config) {
        this.config = config;
        return this;
    }
    ...
    public CopyAutoGenerator setTemplateEngine(AbstractTemplateEngine templateEngine) {
