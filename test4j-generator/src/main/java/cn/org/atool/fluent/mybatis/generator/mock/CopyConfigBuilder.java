...
// * @since 2016-08-30
// */
//public class CopyConfigBuilder extends ConfigBuilder {
//
//    /**
//     * 模板路径配置信息
//     */
...
//     */
//    public CopyConfigBuilder(PackageConfig packageConfig, DataSourceConfig dataSourceConfig, StrategyConfig strategyConfig,
...
//            } else {
//                entityName = NamingStrategy.capitalFirst(processName2(tableInfo.getName(), strategy, tablePrefix));
//            }
...
//            includeTableList.forEach(ti -> convertTableFields2(ti, config));
//        } catch (SQLException e) {
//            e.printStackTrace();
//        }
//        return processTable2(includeTableList, config.getNaming(), config);
//    }
//
//
//    /**
...
//                    } else {
//                        field.setPropertyName(strategyConfig, processName2(field.getName(), config.getNaming()));
//                    }
...
//        return processName2(name, strategy, strategyConfig.getFieldPrefix());
//    }
//
//
//    /**
...
////
////
////    public CopyConfigBuilder setStrategyConfig(StrategyConfig strategyConfig) {
////        this.strategyConfig = strategyConfig;
////        return this;
////    }
////
...
////
////
////    public CopyConfigBuilder setGlobalConfig(GlobalConfig globalConfig) {
////        this.globalConfig = globalConfig;
////        return this;
////    }
////
...
////
////
////    public CopyConfigBuilder setInjectionConfig(InjectionConfig injectionConfig) {
