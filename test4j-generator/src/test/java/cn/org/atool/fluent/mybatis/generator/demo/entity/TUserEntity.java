...
import cn.org.atool.fluent.mybatis.generator.demo.helper.TUserEntityHelper;
...
public class TUserEntity implements IEntity {
    ...
    public Map<String, Object> toMap() {
        return TUserEntityHelper.map(this);
    }
}
