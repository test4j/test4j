...
public interface Constants extends ext.jtester.asm.Opcodes {
	...
	public static final Type TYPE_SIGNATURE = TypeUtils.parseType("ext.jtester.cglib.core.Signature");
