...
class InvocationHandlerGenerator implements CallbackGenerator {
	...
	private static final Type INVOCATION_HANDLER = TypeUtils.parseType("ext.jtester.cglib.proxy.InvocationHandler");
	private static final Type UNDECLARED_THROWABLE_EXCEPTION = TypeUtils
			.parseType("ext.jtester.cglib.proxy.UndeclaredThrowableException");
