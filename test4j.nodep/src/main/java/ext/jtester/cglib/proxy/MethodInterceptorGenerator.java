...
import ext.jtester.cglib.core.ClassInfo;
...
class MethodInterceptorGenerator implements CallbackGenerator {
	...
	private static final Type REFLECT_UTILS = TypeUtils.parseType("ext.jtester.cglib.core.ReflectUtils");
	private static final Type METHOD_PROXY = TypeUtils.parseType("ext.jtester.cglib.proxy.MethodProxy");
	private static final Type METHOD_INTERCEPTOR = TypeUtils.parseType("ext.jtester.cglib.proxy.MethodInterceptor");
