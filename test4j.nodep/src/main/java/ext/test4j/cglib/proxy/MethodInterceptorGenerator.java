...
import ext.test4j.cglib.core.ClassInfo;
...
class MethodInterceptorGenerator implements CallbackGenerator {
    ...
    private static final Type                      REFLECT_UTILS         = TypeUtils
                                                                                 .parseType("ext.test4j.cglib.core.ReflectUtils");
    private static final Type                      METHOD_PROXY          = TypeUtils
                                                                                 .parseType("ext.test4j.cglib.proxy.MethodProxy");
    private static final Type                      METHOD_INTERCEPTOR    = TypeUtils
                                                                                 .parseType("ext.test4j.cglib.proxy.MethodInterceptor");
    ...
    private static final Signature                 MAKE_PROXY            = new Signature("create", METHOD_PROXY,
                                                                                 new Type[] { Constants.TYPE_CLASS,
            Constants.TYPE_CLASS, Constants.TYPE_STRING, Constants.TYPE_STRING, Constants.TYPE_STRING });
    ...
    private static final Signature                 FIND_PROXY            = new Signature(
                                                                                 FIND_PROXY_NAME,
                                                                                 METHOD_PROXY,
