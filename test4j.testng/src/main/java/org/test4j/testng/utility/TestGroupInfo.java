...
public class TestGroupInfo {
    ...
    private final Map<String, TestClazzInfoByGroup> userMethods;             // <GroupName,ClazzMethodInfo>
    ...
    public String htmlReport() {
        try {
            ...
            buffer.append("<style>");
            InputStream is = ResourceHelper.getResourceAsStream("org/test4j/testng/UserTestReporter.css");
            if (is != null) {
